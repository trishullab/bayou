...
public class SynthesizerDefault implements Synthesizer {

    /**
     * Place to send application logging information.
     */
    private static final Logger _logger = LogManager.getLogger(SynthesizerDefault.class.getName());
    ...
    public SynthesizerDefault(String classpath)
    {
        _classpath = classpath == null? "" : classpath;
    }
    ...
    @Override
    public List<String> synthesize(String source, String astJson) throws IOException, ParseException {
        ...
        parser.setEnvironment(new String[] { _classpath },
        ...
        for (String cp : _classpath.split(File.pathSeparator))
        {
            _logger.trace("cp: " + cp);

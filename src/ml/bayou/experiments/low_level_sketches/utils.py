...
def extract_evidence(clargs):
    ...
    for program in js['programs']:
        ...
        apicalls = list(set(chain.from_iterable([bayou.experiments.low_level_sketches.evidence.APICalls.from_call(call) for call in calls])))
        types = list(set(chain.from_iterable([bayou.experiments.low_level_sketches.evidence.Types.from_call(call) for call in calls])))
        context = list(set(chain.from_iterable([bayou.experiments.low_level_sketches.evidence.Context.from_call(call) for call in calls])))
